...
%                                                 |                                                 |
% ===================================================================================================
\section{Use case results}\label{sec:use_case_results}
...
% ===================================================================================================
\subsection{The energy consumption of data centers}\label{sec:energy_of_data_centers}
%---
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.45\textwidth]{fig/data_center_energy_consumption.png}
...
%\begin{figure}[!ht]
%	\centering
%	\includegraphics[width=0.45\textwidth]{fig/manufacturers}
...
%\begin{figure}[h]
%	\centering
%	\includegraphics[width=0.45\textwidth]{fig/industrial_robots_average_power_per_category}
