...
To contrast the knowledge acquisition capabilities of all the leanring paradigms, we defined Eq.~\eqref{eq:collective_knowledge_dynamics} to model the dynamics of the remaining knowledge to be learned for all paradigms, where the terms in the right-hand-side of the expression show how to move from \ac{il} dynamics to \ac{cl} dynamics. The different expressions are displayed in Table~\ref{tab:learning_paradigms_expressions}. 
