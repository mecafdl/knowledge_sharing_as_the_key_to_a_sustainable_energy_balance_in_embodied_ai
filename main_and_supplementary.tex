...
%As AI technology develops it steadily permeates many aspects of human life. As a result, smart factories will become the norm \cite{Szczepanski2019Economicimpactsartificial}, healthcare services will modernize to integrate the analysis and prediction power of AI services, and households will morph into mostly automated environments.
...
%\begin{figure}[!t]
%	\centering
%	\includegraphics[width=0.95\textwidth]{fig/embodied_ai_learning_pipeline.png}
...
\begin{figure*}[!t]
	...
	\end{subfigure}	
	\hspace*{\fill}
	\caption[] {\label{fig:cai_and_eai_general} \textbf{Classical and embodied AI.} \subref{fig:cai_and_eai} Differences in learning and deployment in CAI and EAI. \subref{fig:embodied_ai_pipeline} Standard skill execution pipeline of isolated EAI agents.}
\end{figure*}
% ---
...
%The remarkable progress across various domains, attributed to the exponential growth of AI and machine learning applications, comes with costs. These advancements demand substantial computational power for cutting-edge machine learning algorithms to process, analyze, and learn from extensive data, often requiring numerous iterations to converge \cite{Strubell2019EnergyPolicyConsiderations}. Researchers and corporations rely on existing infrastructure or cloud computing services in data centers for the energy-intensive computational workloads for the learning and deployment phases. \myhl{This has clearly increased the energy consumption in data centers and associated hardware, like Graphics Processing Units (GPUs); as training AI models in data centers is estimated to require about three times more energy than traditional cloud tasks \cite{Thomas2023cloudusesmassive}. Consider as an example the latest breakthroughs brought about by generative AI: large language models and text-to-image models. The number of parameters in such models are in the billions and their training requires thousands of deep learning GPU units and millions of GPU hours \cite{Vanian2023ChatGPTgenerativeAI, Corbyn2023Nvidiachipmaker}.} For instance, in Germany, data center energy consumption surged from 10 TWh in 2010 to 17 TWh in 2021, with projections reaching 28 TWh by 2030 \cite{Hintemann2022Cloudcomputingdrives}. Globally, data center energy consumption rose from 200 TWh to an estimated 220-320 TWh between 2015 and 2021\footnote{Data from the International Energy Agency, available at \url{https://www.iea.org/reports/data-centres-and-data-transmission-networks}}. This trend is illustrated in Figure~\ref{fig:dataCenterEnergy}. \myhl{To face this expected increase in the energy demands to host machine learning processes in data centers companies such as Microsoft to consider nuclear energy to power their data centers\footnote{See \url{https://www.theverge.com/2023/9/26/23889956/microsoft-next-generation-nuclear-energy-smr-job-hiring}}.}

%\myhl{The remarkable progress across various domains, attributed to the exponential growth of AI and machine learning applications, comes with costs. These advancements demand substantial computational power for cutting-edge machine learning algorithms to process, analyze, and learn from extensive data, often requiring numerous iterations to converge \cite{Strubell2019EnergyPolicyConsiderations}. Researchers and corporations rely on existing infrastructure or cloud computing services in data centers for the energy-intensive computational workloads for the learning and deployment phases. This has clearly increased the energy consumption in data centers and associated hardware, like Graphics Processing Units (GPUs); as training AI models in data centers is estimated to require about three times more energy than traditional cloud tasks \cite{Thomas2023cloudusesmassive}. Consider as an example the latest breakthroughs brought about by generative AI: large language models and text-to-image models. The number of parameters in such models are in the billions and their training requires thousands of deep learning GPU units and millions of GPU hours \cite{Vanian2023ChatGPTgenerativeAI, Corbyn2023Nvidiachipmaker}. With more and more AI applications under development, the AI infrastructure is undergoing a similar rise with many GPU-based AI servers being sold to satisfy the demand. Naturally, the rise in data center energy consumption is only expected to grow. Globally, data center energy consumption rose from 200 TWh in 2015 to an estimated 220-320 TWh in 2021\footnote{Data from the International Energy Agency, available at \url{https://www.iea.org/reports/data-centres-and-data-transmission-networks}}. This trend is illustrated in Figure~\ref{fig:dataCenterEnergy}. To face this expected increase in the energy demands to host machine learning processes in data centers companies such as Microsoft to consider nuclear energy to power their data centers\footnote{See \url{https://www.theverge.com/2023/9/26/23889956/microsoft-next-generation-nuclear-energy-smr-job-hiring}}.}
...
%In anticipation of the expected surge in energy demands to host machine learning processes in data centers, companies such as Microsoft are contemplating the utilization of nuclear energy to power their data centers. This underlines the urgent need for sustainable solutions to balance the incredible strides in AI with the environmental implications of such progress.



This escalating energy usage has sparked growing concerns within the research community regarding the adverse environmental effects of AI and machine learning. Recent discussions on this matter, such as \cite{schwartz2019green}, \cite{vinuesa2020role},  \cite{Strubell2019EnergyPolicyConsiderations}, and \cite{Luccioni2023EstimatingCarbonFootprint}, delve into the efficiency of computation-intensive deep learning algorithms. %The staggering increase---more than 300,000 times over the last decade---in the number of computations required by these algorithms is notable \cite{schwartz2019green}. 
