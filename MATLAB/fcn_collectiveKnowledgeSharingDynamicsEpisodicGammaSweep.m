function d_coupledRemainingKnowledge = ...
    ...
    gamma_test = linspace(-0.2,1,numel(parameters.episodes));
    ...
    gamma_index = floor(episodeIntegrationStep*10 + 1)
    % gamma_index = floor(episodeIntegrationStep + 1);

    weightedAdjacencyMatrix      = fcn_generateGamma(gamma_test(gamma_index), parameters.gamma_std, numberOfRobots);
