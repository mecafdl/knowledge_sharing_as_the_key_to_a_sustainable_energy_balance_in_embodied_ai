...
k1w2 = (1 - simil)*(1 - exp(-(1/tcnst_1)*(iter))) + simil*(1 - exp(-(1/tcnst_1 + 1/tcnst_2)*iter));
...
leg = legend([p1,p2,p3,p4,p5,p6,p7,p8],'$k_1$','$k_{1\leftarrow 2}$','$k_{1|2}$','$k_{1+2}$','$k_2$','$k_{2\leftarrow 1}$','$k_{2|1}$','$k_{2+1}$');
